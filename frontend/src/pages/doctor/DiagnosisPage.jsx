...
function DiagnosisPage() {
    ...
    const getDiagnosisCategoryLabel = (category) => {
        if (!category) return '-'
        if (typeof category === 'string') return category
        return category.name || category.code || category._id || '-'
    }
            ...
            <head>
                ...
                <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    .patient-name { text-align: center; font-weight: bold; margin-bottom: 10px; font-size: 18px; }
                    .info-row { display: flex; justify-content: space-between; margin-bottom: 3px; font-size: 15px; }
                    ...
                    .item { display: flex; justify-content: space-between; margin-bottom: 3px; font-size: 15px; }
                    .subtotal { border-top: 1px dotted #000; margin-top: 5px; padding-top: 5px; font-size: 15px; }
                    .total { border-top: 2px solid #000; margin-top: 10px; padding-top: 10px; font-weight: bold; font-size: 18px; display: flex; justify-content: space-between; }
                    .footer { text-align: center; margin-top: 10px; font-size: 14px; color: #555; }
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <span style={{ fontSize: '11px', color: '#888' }}>({getDiagnosisCategoryLabel(d.category)})</span>
                                                </div>
                                                {isSelected && (
                                                    <input
                                                        type="number"
