...
function AddPatientPage() {
    ...
    const handleSelectExisting = (patient) => {
        ...
        navigate(`${getBasePath()}/patients/diagnosis/${patient._id}?new=1`)
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setTimeout(() => navigate(`${getBasePath()}/patients/diagnosis/${data._id}?new=1`), 1000)
            } else {
    ...
    return (
        <div className="ap-page">
            ...
            <div className="ap-header">
                <button className="ap-back-btn" onClick={() => navigate(`${getBasePath()}/patients`)}>
                    <ArrowLeft size={20} />
                    Orqaga
                </button>
                ...
                <main className="ap-main">
                    ...
                    <form onSubmit={handleSubmit} className="ap-form">
                        ...
                        <div className="ap-actions">
                            <button type="button" className="ap-btn secondary" onClick={() => navigate(`${getBasePath()}/patients`)}>
                                Bekor qilish
                            </button>
